...
- 生成 6 个阅读模块：
  ...
  - Author Intent / 作者意图
- 支持基于文章内容继续追问
- 支持用 comment 优化当前输出：输入反馈后，AI 会重写六段阅读结果
- 支持保存个人笔记
...
- Generates six structured reading sections:
  - Summary
  - Core Points
  - Key Insights
  - Reader Value
...
- Supports comment-driven revision: write feedback and regenerate the six-section analysis
